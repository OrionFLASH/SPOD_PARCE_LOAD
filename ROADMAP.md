...
| # | Задача | Статус |
|---|--------|--------|
| 7.4.1 | Оценить техническую возможность параллельного прогона блоков (CPU/IO, логи; архив SQLite — см. п. 7.5 по блокам) | [ ] |
...
| # | Задача | Статус |
|---|--------|--------|
| 7.5.1 | Разнести archive SQLite по каталогам блоков; имя файла с кодом блока | [ ] |
| 7.5.2 | Конфиг: шаблоны/разделы `db_path` и `archive_db_path` под блоки | [ ] |
| 7.5.3 | Документация + миграция/пояснение для уже существующей общей БД | [ ] |
