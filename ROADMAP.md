...
| # | Задача | Статус |
|---|--------|--------|
| 26.0 | ROADMAP / план / допущения по ТЗ | [v] |
| 26.1 | Каталог страницы, стили, config.json | [v] |
| 26.2 | Турниры + JSON настроек | [v] |
| 26.3 | CSV/Excel загрузка, кодировки, маппинг колонок | [v] |
| 26.4 | Справочник ФИО JSON | [v] |
| 26.5 | Единое ядро FIO/TN (логика PQ) | [v] |
| 26.6 | Диалоги ошибок ФИО и дублей | [v] |
| 26.7 | Выгрузка CSV + XLSX | [v] |
| 26.8 | Тесты, документация, архив | [v] |
| 26.9 | UI панелей (лево/право/верх), этапы, копия, проверка, Excel freeze | [v] |
| 26.16 | ToDo_REPORT_3: превью/колонки, множитель, ФИО-блок, include, JSON+файлы, CSV-гейты, период | [v] |
| 26.17 | CSV после разрешения дублей + показ прошлых решений в диалоге | [v] |
