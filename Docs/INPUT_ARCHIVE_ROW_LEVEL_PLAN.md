...
| STATISTICS | `Табельный номер`, `Код роли`, `Период`, `Дата вступления в роль` | — | Согласовано с заказчиком: **Код роли** вместо наименования роли; добавлена **Дата вступления в роль**. |
