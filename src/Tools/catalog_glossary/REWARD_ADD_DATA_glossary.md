...
- **Смысл (гипотеза):** тексты особенностей: для турнира — в детальной карточке; для награды — показываем в Награде.
...
- **Смысл (гипотеза):** мастер-бейдж: **Y** — для награды / **N** — для турнира.
...
- **Смысл (гипотеза):** тип новости — генерит ИИ (`AIPROMPT`) / по шаблону (`TEMPLATE`).
...
- **Смысл (гипотеза):** преференции, если предусмотрены за награду.
...
- **Смысл (гипотеза):** текст критерия победы для ИИ создания новости.
