...
| `key_compare` | строка | Режим сравнения ключей: `"exact"` (по умолчанию) или `"as_text"` (оба ключа → текст, затем сравнение строк; `18`/`"18"`/`"18.0"` совпадают). Алиас: `"number_as_text"`. |
