...
| `key_compare` | строка | Режим сравнения ключей: `"exact"` (по умолчанию, строгое равенство) или `"number_as_text"` (`18`, `"18"`, `"18.0"` считаются одним ключом). |
