...
В `examples/` лежат готовые JSON для кнопки **«Открыть снимок JSON»**:
...
1. **Открыть сохранённые настройки (JSON)** — снимок, ранее сохранённый кнопкой «Сохранить снимок JSON»
...
Позже снимок можно снова открыть в блоке «Проект» слева.
...
- «Сохранить снимок JSON» / «Открыть снимок JSON» — выгрузка и загрузка значений
